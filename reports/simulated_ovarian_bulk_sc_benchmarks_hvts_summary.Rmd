...
ggplot(plot_df, mapping = aes(x = top_n_hvts)) +
    ...
    geom_ribbon(mapping = aes(ymin = corr_spearman_lower_ci_68,
                              ...
                              fill = tool),
                alpha = 0.1) +
    scale_color_manual(values = c(Ground_truth = "darkgrey",
                                  Isosceles = "black",
                                  IsoQuant = "gold",
                                  FLAMES = "tomato",
                                  Sicelore = "royalblue")) +
    scale_fill_manual(values = c(Ground_truth = "darkgrey",
                                 Isosceles = "black",
                                 IsoQuant = "gold",
                                 FLAMES = "tomato",
                                 Sicelore = "royalblue")) +
    scale_linetype_manual(values = c(Ground_truth = "dashed",
                                     Isosceles = "solid",
                                     IsoQuant = "solid",
                                     FLAMES = "solid",
                                     Sicelore = "solid"),
