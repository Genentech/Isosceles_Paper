---
title: "Nanopore bulk RNA-Seq and scRNA-Seq data benchmarks (all >= 1 TPM transcripts)"
output:
  html_document:
    highlight: pygments
    df_print: paged
...
isoquant_pseudobulk_tpm <- isoquant_pseudobulk_tpm[
    !(rownames(isoquant_pseudobulk_tpm) %in% mt_transcripts_ensembl),
]
...
flames_pseudobulk_tpm <- flames_pseudobulk_tpm[
    !(rownames(flames_pseudobulk_tpm) %in% mt_transcripts_ensembl),
]
...
sicelore_pseudobulk_tpm <- sicelore_pseudobulk_tpm[
    !(rownames(sicelore_pseudobulk_tpm) %in% mt_transcripts_ensembl),
]
