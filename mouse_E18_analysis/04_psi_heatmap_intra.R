...
result_dir <- "04_psi_heatmap_intra"
...
dexseq_results_df <- readRDS("02_run_dexseq_intra/dexseq_results_df.rds")
...
ggsave("results/psi_heatmap_intra.pdf",
       psi_heatmap, height = 3.5, width = 7)
